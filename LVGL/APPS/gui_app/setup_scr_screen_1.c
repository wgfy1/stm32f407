...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen_1, lv_color_hex(0xdcdcdc), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_1_btn_1_label, "实时温湿度");
    ...
    lv_obj_set_pos(ui->screen_1_btn_1, 33, 53);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_1, &lv_font_ali_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_1_btn_2_label, "天气");
    ...
    lv_obj_set_pos(ui->screen_1_btn_2, 187, 53);
    ...
    lv_obj_set_style_text_font(ui->screen_1_btn_2, &lv_font_ali_16, LV_PART_MAIN|LV_STATE_DEFAULT);
