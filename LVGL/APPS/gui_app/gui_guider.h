...
LV_IMG_DECLARE(_temputrue_alpha_64x50);
LV_IMG_DECLARE(_shidu_alpha_64x50);

LV_FONT_DECLARE(lv_font_Alibaba_PuHuiTi_Regular_60)
LV_FONT_DECLARE(lv_font_Alibaba_PuHuiTi_Regular_16)
LV_FONT_DECLARE(lv_font_Alibaba_PuHuiTi_Regular_20)
LV_FONT_DECLARE(lv_font_Alibaba_PuHuiTi_Regular_12)

// 自定义字体声明
LV_FONT_DECLARE(lv_font_ali_12)
LV_FONT_DECLARE(lv_font_ali_16)
LV_FONT_DECLARE(lv_font_ali_20)
LV_FONT_DECLARE(lv_font_ali_60)
