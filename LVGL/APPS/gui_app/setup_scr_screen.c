...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen, lv_color_hex(0xdcdcdc), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_time, &lv_font_Alibaba_PuHuiTi_Regular_60, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_date, &lv_font_Alibaba_PuHuiTi_Regular_16, LV_PART_MAIN|LV_STATE_DEFAULT);
