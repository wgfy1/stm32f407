...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, T_SCK_Pin|T_MOSI_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LCD_BL_Pin T_CS_Pin T_SCK_Pin T_MOSI_Pin */
  GPIO_InitStruct.Pin = LCD_BL_Pin|T_CS_Pin|T_SCK_Pin|T_MOSI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
